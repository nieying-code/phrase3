"""CLI for explicitly authorized Phase 6 M2 development execution."""
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--config",
        default="configs/phase6_m2_supply_disruption.yaml",
    )
    parser.add_argument(
        "--runner-config",
        default="configs/phase6_m2_runner.yaml",
    )
    parser.add_argument("--approval", default=M2_DEVELOPMENT_APPROVAL)
