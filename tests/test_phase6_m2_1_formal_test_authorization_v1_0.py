...
def test_authorization_binds_exact_reviewed_runner_and_freeze() -> None:
    ...
    bindings = {
        "runner_module_sha256": ("src/phase6_m2_1_formal_test.py", "runner_module"),
...
def test_authorization_preserves_five_approved_experiment_fingerprints() -> None:
    approval = yaml.safe_load(AUTH.read_text(encoding="utf-8"))
