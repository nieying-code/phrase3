...
上述五族工时均可从审计文件独立复算：E1/E2/E4/E5记录正式工作单元数、
保守完整计划吞吐率及对应pilot来源；E3记录519,000次补救LP、保守LP吞吐率
和全部12条E3 pilot来源。机器门槛还同时要求矩阵处于冻结状态、E3与family
前序完整、五族全部成功投影且不存在失败或歧义运行。

受控根目录内读取了已批准的V1/V2/P1 E3 registry/projection与family前序
制品，并写入当前P2制品及更新后的E3 registry/projection；未读取该受控根目录
之外的历史输出。
